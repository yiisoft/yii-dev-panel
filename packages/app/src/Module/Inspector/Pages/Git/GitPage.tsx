...
import {
    ...
    useCommandMutation,
    useGetSummaryQuery,
} from '@yii-dev-panel/app/Module/Inspector/API/GitApi';
import {CheckoutDialog} from '@yii-dev-panel/app/Module/Inspector/Component/Git/CheckoutDialog';
import {CodeHighlight} from '@yii-dev-panel/sdk/Component/CodeHighlight';
import {BreadcrumbsContext} from '@yii-dev-panel/app/Module/Inspector/Context/BreadcrumbsContext';
